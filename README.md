...
## 使用说明
> 本项目基于[weibo-search](https://github.com/dataabc/weibo-search)开发，实现以下功能
> 1. 爬取微博评论，包括评论id、评论内容、评论时间、点赞数、回复数等信息。
> 2. 基于`Python`的`streamlit`库实现了的可视化界面，可以直观地查看微博信息和评论信息。


- 1_🏠_主页
  
  - 主页，展示搜索结果，可以选择搜索条件，点击搜索按钮进行搜索。
  
  ![image-20250314102257163](https://xu17-1326239041.cos.ap-guangzhou.myqcloud.com/xu17/202503141022441.png)
- 2_🕷️_微博爬虫
  
  - 微博爬虫控制面板
  
  ![image-20250314102320833](https://xu17-1326239041.cos.ap-guangzhou.myqcloud.com/xu17/202503141023120.png)
- 3_📊_数据分析.py

  - 微博文章信息

  ![](https://xu17-1326239041.cos.ap-guangzhou.myqcloud.com/xu17/202503141025474.png)

  - 微博评论信息

  ![image-20250314102530166](https://xu17-1326239041.cos.ap-guangzhou.myqcloud.com/xu17/202503141025471.png)
...
- 4_📈_对比分析
  ...
  ![image-20250314102606216](https://xu17-1326239041.cos.ap-guangzhou.myqcloud.com/xu17/202503141026522.png)
- 5_🎨_设置主题
- 6_📖_关于
...
- 爬取微博信息，包括微博id、bid、内容、头条文章url、原始图片url、视频url、发布位置、发布时间、点赞数、转发数等信息。

- 爬取微博评论，包括评论id、评论内容、评论时间、点赞数、回复数等信息。
